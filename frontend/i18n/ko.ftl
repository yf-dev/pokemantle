...
faq-generation-description = 포켓몬스터 스칼렛·바이올렛까지 등장한 포켓몬을 모두 포함하며, 서로 다른 특징을 가지는 폼체인지 등은 별도의 포켓몬으로 취급하여 총 {$number} 가지입니다. 
...
faq-similarity-description = 포켓몬의 특징(세대, 분류, 타입, 특성, 종족값, 키, 몸무게, 경험치 그룹, 리전폼, 메가진화, 거다이맥스, 파트너, 폼체인지, 환상/전설, 알그룹)을 기반으로 유사도를 계산합니다.
  더 정확하게는 각각의 특징을 벡터로 변환하여 유클리드/코사인 유사도를 계산합니다.
...
ability-anger-shell = 분노의껍질
ability-anticipation = 위험예지
ability-arena-trap = 개미지옥
ability-armor-tail = 테일아머
...
ability-earth-eater = 흙먹기
ability-effect-spore = 포자
ability-electric-surge = 일렉트릭메이커
ability-electromorphosis = 전기로바꾸기
...
ability-guard-dog = 파수견
ability-gulp-missile = 그대로꿀꺽미사일
ability-guts = 근성
ability-hadron-engine = 하드론엔진
ability-harvest = 수확
...
ability-limber = 유연
ability-lingering-aroma = 가시지않는향기
...
ability-opportunist = 편승
ability-orichalcum-pulse = 진홍빛고동
ability-overcoat = 방진
ability-overgrow = 심록
