...
faq-generation-description = It includes all Pokémon, even appeared in Pokémon Scarlet and Pokémon Violet, and form differences with different characteristics are treated as a separate Pokémon. In total, there are {$number} Pokémon.
...
faq-similarity-description = Similarity is calculated based on the characteristics of Pokémon(generation, category, type, ability, stat, height, weight, experience group, regional form, mega evolution, gigantamax, partner, form difference, mythical/legendary, egg group).
...
pokemon-info-etc-is-paldean = Paldean
...
pokemon-info-etc-is-gigantamax = Gigantamax
...
ability-beads-of-ruin = Beads of Ruin
...
ability-costar = Costar
ability-cotton-down = Cotton Down
ability-cud-chew = Cud Chew
...
ability-earth-eater = Earth Eater
...
ability-good-as-gold = Good as Gold
ability-gooey = Gooey
...
ability-guard-dog = Guard Dog
ability-gulp-missile = Gulp Missile
ability-guts = Guts
ability-hadron-engine = Hadron Engine
...
ability-lingering-aroma = Lingering Aroma
...
ability-mummy = Mummy
ability-mycelium-might = Mycelium Might
...
ability-opportunist = Opportunist
ability-orichalcum-pulse = Orichalcum Pulse
...
ability-purifying-salt = Purifying Salt
ability-quark-drive = Quark Drive
...
ability-rocky-payload = Rocky Payload
...
ability-thermal-exchange = Thermal Exchange
...
ability-vessel-of-ruin = Vessel of Ruin
