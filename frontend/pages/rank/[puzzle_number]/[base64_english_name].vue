<template>
  <div>
    <MenuBar :subtitle="$t('pokemantle-rank-subtitle', { puzzle_number: puzzle_number })" />
    ...
    <ClientOnly>
      <GuessResult :guess_list="rank_data.guess_list" v-if="rank_data.guess_list.length > 0" />
    </ClientOnly>
  </div>
</template>
...
if (typeof route.params.puzzle_number === 'string' && typeof route.params.base64_english_name === 'string') {
