<template>
  <div class="grid grid-cols-1 zs:grid-cols-2 xs:grid-cols-3 gap-2 text-xs dark:text-slate-300">
    <PokemonInfoBlock>
    ...
    <PokemonInfoBlock>
      ...
      <p class="leading-relaxed">{{ $t('pokemon-info-etc-label') }}
        ...
        <PokemonInfoTag v-if="pokemon.is_alolan" class="bg-orange-200 dark:bg-orange-900">{{
            $t('pokemon-info-etc-is-alolan')
        }}
        </PokemonInfoTag>
        <PokemonInfoTag v-if="pokemon.is_mega" class="bg-lime-200 dark:bg-lime-900">{{
            $t('pokemon-info-etc-is-mega')
        }}
        </PokemonInfoTag>
        <PokemonInfoTag v-if="pokemon.is_partner" class="bg-indigo-200 dark:bg-indigo-900">{{
